...
const uploadImage = multer({
  storage: multers3({
    ...
    key: (req, file, callback) => {
      ...
      const bizPhoto = `https://dawhisky.s3.ap-northeast-2.amazonaws.com/dawhiskybiz/${date}_${randomNumber}`;
      req.bizPhoto = bizPhoto;

      callback(null, `biz_photo/${date}_${randomNumber}`);
    },
    acl: "public-read",
  }),
  limits: {
